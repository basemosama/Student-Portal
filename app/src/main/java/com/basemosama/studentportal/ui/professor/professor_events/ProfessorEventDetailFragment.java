...
public class ProfessorEventDetailFragment extends Fragment {
    private FragmentEventDetailBinding eventDetailBinding;
    private ProfessorEventViewModel viewModel;
    ...
    private void setUpViewModel() {
        ...
        viewModel = viewModelProvider.get(ProfessorEventViewModel.class);
